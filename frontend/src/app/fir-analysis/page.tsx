...
// the "Download Full Report" control needs a single text blob, but this
// page renders the analysis as many separate small cards, not one blob.
// Built here rather than duplicated per-field so PDF and Word exports stay
// in sync automatically whenever a new field is added to a card above.
