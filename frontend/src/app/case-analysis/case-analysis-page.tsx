...
import { FileSearch, Loader2, Scale, Brain } from 'lucide-react';
...
function CaseAnalysisContent() {
  ...
  const handleDeepAnalyze = async () => {
    ...
    const steps = [
      'Spotting the strongest issue in the case...',
      'Researching applicable law for it...',
      'Building the strongest argument on each side...',
      'Simulating the opposing side\'s rebuttal...',
    ...
    try {
      const { data } = await api.post('/analysis/plaint/deep', { text, documentId });
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-400 mt-1.5 text-center">
                Slower (~20-40s) but reasons through the strongest issue in depth, arguing both sides before
